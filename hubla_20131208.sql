...
--
-- Table structure for table `tbl_checkpoint_e2`
--

DROP TABLE IF EXISTS `tbl_checkpoint_e2`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tbl_checkpoint_e2` (
  `id_checkpoint_e2` bigint(20) NOT NULL AUTO_INCREMENT,
  `id_pk_e2` int(11) NOT NULL,
  `unit_kerja` varchar(100) DEFAULT NULL,
  `periode` smallint(6) DEFAULT NULL,
  `kriteria` varchar(255) DEFAULT NULL,
  `ukuran` varchar(255) DEFAULT NULL,
  ...
  `log_update` varchar(50) DEFAULT NULL,
  `nama_folder_pendukung` varchar(30) DEFAULT NULL,
  PRIMARY KEY (`id_checkpoint_e2`),
  KEY `fk_checkpoint_penetapan_e2` (`id_pk_e2`),
  CONSTRAINT `fk_checkpoint_penetapan_e2` FOREIGN KEY (`id_pk_e2`) REFERENCES `tbl_pk_eselon2` (`id_pk_e2`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tbl_checkpoint_e2`
--

LOCK TABLES `tbl_checkpoint_e2` WRITE;
/*!40000 ALTER TABLE `tbl_checkpoint_e2` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_checkpoint_e2` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `tbl_datapendukung_e2`
--

DROP TABLE IF EXISTS `tbl_datapendukung_e2`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tbl_datapendukung_e2` (
  `id_datapendukung_e2` bigint(20) NOT NULL AUTO_INCREMENT,
  `id_checkpoint_e2` bigint(20) NOT NULL,
  `nama_file` varchar(100) DEFAULT NULL,
  `lokasi_file` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`id_datapendukung_e2`),
  KEY `fk_checkpoint_pendukung_e2` (`id_checkpoint_e2`),
  CONSTRAINT `fk_checkpoint_pendukung_e2` FOREIGN KEY (`id_checkpoint_e2`) REFERENCES `tbl_checkpoint_e2` (`id_checkpoint_e2`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tbl_datapendukung_e2`
--

LOCK TABLES `tbl_datapendukung_e2` WRITE;
/*!40000 ALTER TABLE `tbl_datapendukung_e2` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_datapendukung_e2` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `tbl_pre_usulan1_e2` VALUES (3,2013,'022.04.01','SSSDPL.01','IKKSSSDPL.02.02','','022.04.08.1959.001',1000,'8;2013-12-04 20:46:35',NULL),(4,2013,'022.04.01','SSSDPL.01','IKKSSSDPL.02.01','','022.04.08.1959.001',343434343434,'8;2013-12-05 10:26:34',NULL),(5,2013,'022.04.01','SSSDPL.01','IKKSSSDPL.02.01','','022.04.08.1959.002',34343434343,'8;2013-12-05 10:26:34',NULL);
...
INSERT INTO `tbl_rkt_eselon2` VALUES (1,'022.04.01',2012,'SSSDPL.01','IKKSSSDPL.01.01','10',0,'8;2013-12-07 10:20:38',NULL),(2,'022.04.01',2012,'SSSDPL.01','IKKSSSDPL.01.02','10',0,'8;2013-12-07 10:20:38',NULL);
...
INSERT INTO `tbl_rkt_eselon2_log` VALUES (1,'022.04.01',2012,'SSSDPL.01','IKKSSSDPL.01.01','10',0,'INSERT;8;2013-12-07 10:20:38'),(2,'022.04.01',2012,'SSSDPL.01','IKKSSSDPL.01.02','10',0,'INSERT;8;2013-12-07 10:20:38');
...
-- Dump completed on 2013-12-08 11:49:38
