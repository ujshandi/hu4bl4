	<script  type="text/javascript" >
		$(function(){
			...
			clearFilter<?=$objectId;?> = function (){
				...
				//$('#dg<?=$objectId;?>').datagrid({url:"<?=base_url()?>realisasi/rseselon1/grid/"+filnip+"/"+filnama+"/"+filalamat});
			}
			...
			editData<?=$objectId;?> = function (){
				...
				if (row){
					$('#dlg<?=$objectId;?>').dialog('open').dialog('setTitle','Edit rseselon1');
					$('#fm<?=$objectId;?>').form('load',row);
					url = base_url+'realisasi/rseselon1/save';//+row.id;//'update_user.php?id='+row.id;
				}
			}
			//end editData
	...
	<table id="dg<?=$objectId;?>" class="easyui-datagrid" style="height:auto;width:auto" title="Realisasi Kinerja Eselon I" toolbar="#tb<?=$objectId;?>" fitColumns="true" singleSelect="true" rownumbers="true" pagination="true">
	  <thead>
	  <tr>
		...
		<th field="kode_sasaran_e1" sortable="true" width="50px">Kode Sasaran Eselon I</th>
		<th field="kode_iku_e1" sortable="true" width="50px">Kode IKU Eselon I</th>
