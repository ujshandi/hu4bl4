				...
				$('#fm<?=$objectId;?>').form('submit',{
					...
					success: function(result){
						...
						if (result.success){
							...
							document.getElementById('kode_satker<?=$objectId?>').selectedIndex = 0;
							document.getElementById('tahun<?=$objectId?>').value = '';
							document.getElementById('triwulan<?=$objectId?>').selectedIndex = 0;
							document.getElementById('tbody<?=$objectId?>').innerHTML = '';
	...
	<script language="javascript">
		...
		function getDetail(){
			...
			var kode_kl 		= document.getElementById('kode_satker<?=$objectId;?>').value;
			var kode_sasaran_kl = document.getElementById('kode_sasaran_e2<?=$objectId;?>').value;
			var response = '';
			...
			<div class="easyui-layout" fit="true">  
				...
				<div region="center" border="true" title="">	
					<form id="fm<?=$objectId;?>" method="post">		
						...
						<div class="fitem">
						    <label style="width:120px">Satker :</label>
