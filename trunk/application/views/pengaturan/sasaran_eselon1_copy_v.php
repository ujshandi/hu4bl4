	<script  type="text/javascript" >
		$(function(){
			...
			cancel<?=$objectId?> = function(){
				$('#tt').tabs('close', 'Copy Sasaran Eselon I');	
			}
			...
			saveCopy<?=$objectId;?>=function(){
				...
				$('#fm<?=$objectId;?>').form('submit',{
					url: base_url+'pengaturan/sasaran_eselon1/saveCopy/'+filtahun+'/'+file1+'/'+filtahuntujuan,
					onSubmit: function(){
	...
	<div  style="height:auto">
	 ...
	 <div id="tab<?=$objectId?>" class="easyui-tabs" style="width:auto;height:auto;">
		<div title="Data Sasaran Unit Kerja Eselon I" style="padding:10px;">
		...
		<div title="Data Sasaran Eselon I Hasil Copy atau Data Tahun Tujuan" style="padding:10px;">
