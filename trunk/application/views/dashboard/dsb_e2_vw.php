	  ...
	  <tr>
		<td>
		  <div class="fsearch" style="">
			...
			<tr>
				<td>Tahun :</td>
				<td><?=$this->dsb_e2_model->getListTahun($objectId)?></td>
			</tr>
...
<div>
<div id="chartKinerjaE2<?=$objectId?>" style="height:350px;width:350px;float:left;color:#FFFFFF"> </div> 
<div  style="width:10px;float:left">&nbsp;</div>

<table id="dg<?=$objectId;?>" class="easyui-datagrid" style="height:350px;width:auto" title="Data Capaian IKU Eselon II"  fitColumns="true" singleSelect="true" rownumbers="true" pagination="true">
	  <thead>
	  <tr>
		<th field="kode_e2" sortable="true" width="20">Kode Unit Kerja</th>		
...
$(document).ready(function(){
	...
	searchData<?=$objectId;?> = function (){
			...
			jQuery.jqplot ('chartKinerjaE2<?=$objectId?>', [objArrayData],{
			...
			//end inisialisasi jqplot
				...
				$('#dg<?=$objectId;?>').datagrid({
					...
					url:"<?=base_url()?>dashboard/dsb_e2/gride2/"+filtahun,
				...
				//	alert(row.id_pk_e1);
                    ...
                    $('#ddv<?=$objectId;?>-'+index).datagrid({
                        url:'<?=base_url()?>dashboard/dsb_e2/grid/'+filtahun+'/'+row.kode_e2+'/?parentIndex='+index,
                        fitColumns:true,
                        singleSelect:true,
                        rownumbers:true,
                        loadMsg:'',
					...
					onClickRow:function(rowIndex, rowData){
						...
						//start jqplot
						  ...
						  var plot1 = jQuery.jqplot ('chartKinerjaE2<?=$objectId?>', [objArrayData],
							{
							  	seriesColors: [ "green","red"]	,
							  gridPadding: {top:0, bottom:38, left:10, right:0},
							seriesDefaults:{
