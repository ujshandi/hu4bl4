...
class Kke2b_e2_model extends CI_Model
{	
	/**
	* constructor
	*/
	...
	public function easyGrid($filtahun=null,$file2=null,$filsasaran=null,$filiku=null,$purpose=1,$pageNumber=null,$pageSize=null){
		...
		if ($count>0){
			...
			$this->db->select("sasaran.deskripsi as sasaran_strategis,sasaran.tahun, sasaran.kode_sasaran_e2,lke.kke2b_e2_id,lke.renstra_a,lke.renstra_a_nilai,lke.rkt_a, lke.rkt_a_nilai, lke.pk_a, lke.pk_a_nilai,lke.renstra_b,lke.renstra_b_nilai,lke.rkt_b, lke.rkt_b_nilai, lke.pk_b, lke.pk_b_nilai,sasaran.kode_e2, e2.nama_e2",false);
			$this->db->from('tbl_sasaran_eselon2 sasaran left join tbl_kke2b_e2 lke on sasaran.kode_sasaran_e2 = lke.kode_sasaran_e2 and sasaran.tahun=lke.tahun inner join tbl_eselon2 e2 on sasaran.kode_e2=e2.kode_e2', false);
			$query = $this->db->get();
			...
			foreach ($query->result() as $row)
			{
				...
				$response->rows[$i]['kke2b_e2_id']=$row->kke2b_e2_id;
...
//utk kepentingan export excel ==========================
	...
	public function InsertOnDb($data,& $error) {
		...
		$result = $this->db->insert('tbl_kke2b_e2');
	...
	public function UpdateOnDb($data, $kode) {
		...
		$this->db->where('kke2b_e2_id',$kode);
		...
		$result=$this->db->update('tbl_kke2b_e2');
	...
	public function GetRecordCount($filtahun=null,$file2=null,$filsasaran=null,$filiku=null){
		...
		//$this->db->select("select sasaran.deskripsi as sasaran_srategis, iku.deskripsi as indikator_kinerja, rkt.target",false);
			$this->db->from('tbl_sasaran_eselon2 sasaran left join tbl_kke2b_e2 lke on sasaran.kode_sasaran_e2 = lke.kode_sasaran_e2 and sasaran.tahun=lke.tahun', false);
