...
class Rpt_capaian_kinerjakl extends CI_Controller {
	...
	function __construct()
	{
		...
		$this->load->model('/realisasi/rpt_capaian_kinerjakl_model');
	...
	function index(){
		...
		$data['title'] = 'Laporan Realisasi Kinerja Kementerian';	
		$data['objectId'] = 'rpt_capaian_kinerjakl';
		//$data['formLookupTarif'] = $this->tarif_model->lookup('#winLookTarif'.$data['objectId'],"#medrek_id".$data['objectId']);
	  	$this->load->view('realisasi/rpt_capaian_kinerjakl_v',$data);
	}
			
	public function grid($filtahun=null,$filsasaran=null,$filiku=null,$filStart=null,$filEnd=null){
		echo $this->rpt_capaian_kinerjakl_model->easyGrid($filtahun,$filsasaran,$filiku,$filStart,$filEnd,1);
	}
	
	public function excel($filtahun=null,$filsasaran=null,$filiku=null,$filStart=null,$filEnd=null,$page=null,$rows=null){
		echo  $this->rpt_capaian_kinerjakl_model->easyGrid($filtahun,$filsasaran,$filiku,$filStart,$filEnd,3,$page,$rows);
	}
	
	public function pdf($filtahun=null,$filsasaran=null,$filiku=null,$filStart=null,$filEnd=null,$page=null,$rows=null){
		$this->load->library('our_pdf');
		$this->our_pdf->FPDF('L', 'mm', 'legal'); 
		$pdfdata = $this->rpt_capaian_kinerjakl_model->easyGrid($filtahun,$filsasaran,$filiku,$filStart,$filEnd,2,$page,$rows);
	...
	//	$this->our_pdf->setAutoPageBreak(true,10);
		...
		$posX = 10;
		 ...
		 $this->our_pdf->text($posX,$posY,'Realisasi Kinerja Kementerian');
		...
		$this->our_pdf->Output("CapaianKinerjaKL.pdf","I");
	}
