...
class Rpt_akuntabilitase2 extends CI_Controller {
	...
	function __construct()
	{
		...
		$this->load->model('/realisasi/rpt_akuntabilitase2_model');
	...
	function index(){
		$data['title'] = 'Sebaran IKK Eselon II';	
		$data['objectId'] = 'rpt_akuntabilitase2';
		//$data['formLookupTarif'] = $this->tarif_model->lookup('#winLookTarif'.$data['objectId'],"#medrek_id".$data['objectId']);
	  	$this->load->view('realisasi/rpt_akuntabilitase2_v',$data);
	}
			
	public function grid($filtahun=null,$filsasaran=null,$filiku=null,$file1=null,$file2=null){
		echo $this->rpt_akuntabilitase2_model->easyGrid($filtahun,$filsasaran,$filiku,$file1,$file2);
	}
	
	public function excel($filtahun=null,$filsasaran=null,$filiku=null,$file1=null,$file2=null,$page=null,$rows=null){
		echo  $this->rpt_akuntabilitase2_model->easyGrid($filtahun,$filsasaran,$filiku,$file1,$file2,3,$page,$rows);
	}
	
	//to pdf
	public function pdf($filtahun=null,$filsasaran=null,$filiku=null,$file1=null,$file2=null,$page=null,$rows=null){
		$this->load->library('cezpdf');	
		$pdfdata = $this->rpt_akuntabilitase2_model->easyGrid($filtahun,$filsasaran,$filiku,$file1,$file2,2,$page,$rows);
	...
	//	$pdf->ezText('Biroren Kemenhub',8,array('left'=>'1'));
		...
		$pdf->ezText('Sebaran IKK '.($e2!=""?$e2:"Eselon II"),16,array('left'=>'1'));
	//	if (($filtahun != null)&&($filtahun != "-1"))
		//	$pdf->ezText('Tahun '.$filtahun,12,array('left'=>'1'));
		if (($file2 != null)&&($file2 != "-1"))
			$pdf->ezText($this->eselon2_model->getNamaE2($file2),12,array('left'=>'1'));
		$pdf->ezText('');
		//halaman 
		...
		$opt['Content-Disposition'] = "SebaranIkkEselon2.pdf";
		$pdf->ezStream($opt);
	}
