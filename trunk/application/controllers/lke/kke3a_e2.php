...
class kke3a_e2 extends CI_Controller {
	var $objectId = 'kke3a_e2';
	function __construct()
	{
		...
		$this->load->model('/lke/kke3a_e2_model');
	...
	function index(){
		...
		$data['renstra_ip_radio'] = $this->lke_konversi_model->getListIndex($this->objectId,array('jenis_lke'=>'kke3a','unit_kerja'=>'e2'),true,"renstra_ip");
		$data['rkt_ip_radio'] = $this->lke_konversi_model->getListIndex($this->objectId,array('jenis_lke'=>'kke3a','unit_kerja'=>'e2'),true,"rkt_ip");
		$data['pk_ip_radio'] = $this->lke_konversi_model->getListIndex($this->objectId,array('jenis_lke'=>'kke3a','unit_kerja'=>'e2'),true,"pk_ip");
		$data['iku_measurable_radio'] = $this->lke_konversi_model->getListIndex($this->objectId,array('jenis_lke'=>'kke3a','unit_kerja'=>'e2'),true,"iku_measurable");
		$data['iku_hasil_radio'] = $this->lke_konversi_model->getListIndex($this->objectId,array('jenis_lke'=>'kke3a','unit_kerja'=>'e2'),true,"iku_hasil");
		$data['iku_relevan_radio'] = $this->lke_konversi_model->getListIndex($this->objectId,array('jenis_lke'=>'kke3a','unit_kerja'=>'e2'),true,"iku_relevan");
		$data['iku_diukur_radio'] = $this->lke_konversi_model->getListIndex($this->objectId,array('jenis_lke'=>'kke3a','unit_kerja'=>'e2'),true,"iku_diukur");
		$data['kriteria_measurable_radio'] = $this->lke_konversi_model->getListIndex($this->objectId,array('jenis_lke'=>'kke3a','unit_kerja'=>'e2'),true,"kriteria_measurable");
		$data['kriteria_hasil_radio'] = $this->lke_konversi_model->getListIndex($this->objectId,array('jenis_lke'=>'kke3a','unit_kerja'=>'e2'),true,"kriteria_hasil");
		$data['kriteria_relevan_radio'] = $this->lke_konversi_model->getListIndex($this->objectId,array('jenis_lke'=>'kke3a','unit_kerja'=>'e2'),true,"kriteria_relevan");
		$data['kriteria_diukur_radio'] = $this->lke_konversi_model->getListIndex($this->objectId,array('jenis_lke'=>'kke3a','unit_kerja'=>'e2'),true,"kriteria_diukur");
		$data['pengukuran_radio'] = $this->lke_konversi_model->getListIndex($this->objectId,array('jenis_lke'=>'kke3a','unit_kerja'=>'e2'),true,"pengukuran");
		
		$data['listIndex_renstra_ip'] = $this->lke_konversi_model->getCountIndex(array('jenis_lke'=>'kke3a','unit_kerja'=>'e2'),true);
		$data['listIndex_rkt_ip'] = $this->lke_konversi_model->getCountIndex(array('jenis_lke'=>'kke3a','unit_kerja'=>'e2'),true);
		$data['listIndex_pk_ip'] = $this->lke_konversi_model->getCountIndex(array('jenis_lke'=>'kke3a','unit_kerja'=>'e2'),true);
		$data['listIndex_iku_measurable'] = $this->lke_konversi_model->getCountIndex(array('jenis_lke'=>'kke3a','unit_kerja'=>'e2'),true);
		$data['listIndex_iku_hasil'] = $this->lke_konversi_model->getCountIndex(array('jenis_lke'=>'kke3a','unit_kerja'=>'e2'),true);
		$data['listIndex_iku_relevan'] = $this->lke_konversi_model->getCountIndex(array('jenis_lke'=>'kke3a','unit_kerja'=>'e2'),true);
		$data['listIndex_iku_diukur'] = $this->lke_konversi_model->getCountIndex(array('jenis_lke'=>'kke3a','unit_kerja'=>'e2'),true);
		$data['listIndex_kriteria_measurable'] = $this->lke_konversi_model->getCountIndex(array('jenis_lke'=>'kke3a','unit_kerja'=>'e2'),true);
		$data['listIndex_kriteria_hasil'] = $this->lke_konversi_model->getCountIndex(array('jenis_lke'=>'kke3a','unit_kerja'=>'e2'),true);
		$data['listIndex_kriteria_relevan'] = $this->lke_konversi_model->getCountIndex(array('jenis_lke'=>'kke3a','unit_kerja'=>'e2'),true);
		$data['listIndex_kriteria_diukur'] = $this->lke_konversi_model->getCountIndex(array('jenis_lke'=>'kke3a','unit_kerja'=>'e2'),true);
		$data['listIndex_pengukuran'] = $this->lke_konversi_model->getCountIndex(array('jenis_lke'=>'kke3a','unit_kerja'=>'e2'),true);
	  	$this->load->view('lke/kke3a_e2_v',$data);
	}
	
	private function get_form_values() {
		$dt['tahun'] = $this->input->post("tahun", TRUE); 
		$dt['kke3a_e2_id'] = $this->input->post("kke3a_e2_id", TRUE); 
		...
		$dt['renstra_ip_nilai'] = $this->lke_konversi_model->getKonversi('kke3a',$dt['renstra_ip'],'e2');
		$dt['rkt_ip'] = $this->input->post("rkt_ip", TRUE); 
		$dt['rkt_ip_nilai'] = $this->lke_konversi_model->getKonversi('kke3a',$dt['rkt_ip'],'e2');
		$dt['pk_ip'] = $this->input->post("pk_ip", TRUE); 
		$dt['pk_ip_nilai'] = $this->lke_konversi_model->getKonversi('kke3a',$dt['pk_ip'],'e2');
		$dt['iku_measurable'] = $this->input->post("iku_measurable", TRUE); 
		$dt['iku_measurable_nilai'] = $this->lke_konversi_model->getKonversi('kke3a',$dt['iku_measurable'],'e2');
		$dt['iku_hasil'] = $this->input->post("iku_hasil", TRUE); 
		$dt['iku_hasil_nilai'] = $this->lke_konversi_model->getKonversi('kke3a',$dt['iku_hasil'],'e2');
		$dt['iku_relevan'] = $this->input->post("iku_relevan", TRUE); 
		$dt['iku_relevan_nilai'] = $this->lke_konversi_model->getKonversi('kke3a',$dt['iku_relevan'],'e2');
		$dt['iku_diukur'] = $this->input->post("iku_diukur", TRUE); 
		$dt['iku_diukur_nilai'] = $this->lke_konversi_model->getKonversi('kke3a',$dt['iku_diukur'],'e2');
		$dt['kriteria_measurable'] = $this->input->post("kriteria_measurable", TRUE); 
		$dt['kriteria_measurable_nilai'] = $this->lke_konversi_model->getKonversi('kke3a',$dt['kriteria_measurable'],'e2');
		$dt['kriteria_hasil'] = $this->input->post("kriteria_hasil", TRUE); 
		$dt['kriteria_hasil_nilai'] = $this->lke_konversi_model->getKonversi('kke3a',$dt['kriteria_hasil'],'e2');
		$dt['kriteria_relevan'] = $this->input->post("kriteria_relevan", TRUE); 
		$dt['kriteria_relevan_nilai'] = $this->lke_konversi_model->getKonversi('kke3a',$dt['kriteria_relevan'],'e2');
		$dt['kriteria_diukur'] = $this->input->post("kriteria_diukur", TRUE); 
		$dt['kriteria_diukur_nilai'] = $this->lke_konversi_model->getKonversi('kke3a',$dt['kriteria_diukur'],'e2');
		$pengukuran = 'T';
		...
		$dt['pengukuran_nilai'] = $this->lke_konversi_model->getKonversi('kke3a',$dt['pengukuran'],'e2');
		return $dt;
    }
	...
	//	$this->form_validation->set_rules("index_mutu", 'Index Mutu', 'trim|required|xss_clean');
		...
		if ($this->form_validation->run() == FALSE){ // jika tidak valid
			...
			// validasi detail
				...
				if ($data['kke3a_e2_id']==''){	
					$result = $this->kke3a_e2_model->InsertOnDb($data,$data['pesan_error']);
				}
				else {
					$result = $this->kke3a_e2_model->UpdateOnDb($data,$data['kke3a_e2_id']);
				}
	...
	function grid($filtahun=null,$file2=null,$filsasaran=null,$filiku=null){
		if ($file2==null)
			$file2 = $this->session->userdata('unit_kerja_e1');
		echo $this->kke3a_e2_model->easyGrid($filtahun,$file2,$filsasaran,$filiku);
	}
	
	public function excel($filtahun=null,$file2=null,$filsasaran=null,$filiku=null,$page=null,$rows=null){
		echo  $this->kke3a_e2_model->easyGrid($filtahun,$file2,$filsasaran,$filiku,3,$page,$rows);
	}
	...
	public function pdf($filtahun=null,$file2=null,$filsasaran=null,$filiku=null,$page=null,$rows=null){
		...
		$pdfdata = $this->kke3a_e2_model->easyGrid($filtahun,$file2,$filsasaran,$filiku,2,$page,$rows);
	...
	//	$this->our_pdf->setAutoPageBreak(true,10);
		...
		if (($file2 != null)&&($file2 != "-1"))
			$e1=$this->eselon1_model->getNamaE1($file2);
	...
	function getSatuan($id){
		echo $this->kke3a_e2_model->getSatuan($id);
	}
