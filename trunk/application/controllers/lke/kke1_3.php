...
class Kke1_3 extends CI_Controller {
	...
	function save(){
		...
		$this->form_validation->set_rules("kode_e1", 'Unit Kerja Eselonn I', 'trim|required|xss_clean');
	...
	function grid($filtahun=null,$file1=null,$filsasaran=null,$filiku=null){
		...
		echo $this->kke1_3_model->easyGrid($filtahun,$file1,$filsasaran,$filiku);
	}
	
	public function excel($filtahun=null,$file1=null,$filsasaran=null,$filiku=null,$page=null,$rows=null){
		echo  $this->kke1_3_model->easyGrid($filtahun,$file1,$filsasaran,$filiku,3,$page,$rows);
	}
	...
	public function pdf($filtahun=null,$file1=null,$filsasaran=null,$filiku=null,$page=null,$rows=null){
		...
		$pdfdata = $this->kke1_3_model->easyGrid($filtahun,$file1,$filsasaran,$filiku,2,$page,$rows);
	...
	function getSatuan($id){
		echo $this->kke1_3_model->getSatuan($id);
	}
