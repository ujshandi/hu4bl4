...
class Sasaran_kl extends CI_Controller {
	...
	function index(){
		...
		$data['objectId'] = 'SasaranKL';
	  	$this->load->view('pengaturan/sasaran_kl_v',$data);
	}
	...
	function save($aksi="", $kode="",$tahun=''){
		...
		//validasi form
		$this->form_validation->set_rules("kode_sasaran_kl", 'Kode Sasaran KL', 'trim|required|xss_clean');
