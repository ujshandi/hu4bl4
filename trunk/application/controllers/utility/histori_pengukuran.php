...
class histori_pengukuran extends CI_Controller {
	...
	//	$userdata = array ('userLogin' => $userLogin,'logged_in' => TRUE,'groupId'=>$this->sys_login_model->groupId,'fullName'=>$this->sys_login_model->fullName,'userId'=>$this->sys_login_model->userId,'groupLevel'=>$this->sys_login_model->level);
		...
		$this->load->model('/utility/histori_pengukuran_model');
	...
	function index(){
		...
		$data['objectId'] = 'historipengukuran';
	  	$this->load->view('utility/histori_pengukuran_v',$data);
		//$this->load->view('footer_vw',$data);
	}
	
	
	function KL_grid($filtahun=null){
		echo $this->histori_pengukuran_model->KL_grid($filtahun,1);
	}
	
	function KL_pdf($filtahun=null){
		$this->load->library('cezpdf');	
			$pdfdata = $this->histori_pengukuran_model->KL_grid($filtahun,2);
			if (count($pdfdata)==0){
	...
	function KL_excel($filtahun=null){
		echo  $this->histori_pengukuran_model->KL_grid($filtahun,3);
	}
	
	
	function E1_grid($filtahun=null,$file1=null){
		echo $this->histori_pengukuran_model->E1_grid($filtahun,$file1,1);
	}
	
	function E1_pdf($filtahun=null,$file1=null){
		$this->load->library('cezpdf');	
			$pdfdata = $this->histori_pengukuran_model->E1_grid($filtahun,$file1,2);
			if (count($pdfdata)==0){
				echo "Data Tidak Tersedia";
				return;
			}
	...
	function E1_excel($filtahun=null,$file1=null){
		echo  $this->histori_pengukuran_model->E1_grid($filtahun,$file1,3);
	}
	
	
	function E2_grid($filtahun=null,$file1=null,$file2=null){
		echo $this->histori_pengukuran_model->E2_grid($filtahun,$file1,$file2,1);
	}
	
	function E2_pdf($filtahun=null,$file1=null,$file2=null){
		$this->load->library('cezpdf');	
			$pdfdata = $this->histori_pengukuran_model->E2_grid($filtahun,$file1,$file2,2);
			if (count($pdfdata)==0){
				echo "Data Tidak Tersedia";
				return;
			}
	...
	function E2_excel($filtahun=null,$file1=null,$file2=null){
		echo  $this->histori_pengukuran_model->E2_grid($filtahun,$file1,$file2,3);
	}
