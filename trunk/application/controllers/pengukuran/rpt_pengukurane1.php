...
class Rpt_pengukurane1 extends CI_Controller {
	...
	function __construct()
	{
		...
		$this->load->model('/pengukuran/rpt_pengukurane1_model');
	...
	function index(){
		$data['title'] = 'Laporan Pengukuran Kinerja Kinerja Eselon I';	
		$data['objectId'] = 'rpt_pengukurane1';
		//$data['formLookupTarif'] = $this->tarif_model->lookup('#winLookTarif'.$data['objectId'],"#medrek_id".$data['objectId']);
	  	$this->load->view('pengukuran/rpt_pengukurane1_v',$data);
	}
			
	public function grid($filtahun=null,$filsasaran=null,$filiku=null,$file1=null){
		echo $this->rpt_pengukurane1_model->easyGrid($filtahun,$filsasaran,$filiku,$file1);
	}
	
	public function excel($filtahun=null,$filsasaran=null,$filiku=null,$file1=null,$page=null,$rows=null){
		echo  $this->rpt_pengukurane1_model->easyGrid($filtahun,$filsasaran,$filiku,$file1,3,$page,$rows);
	}
	...
	public function pdf($filtahun=null,$filsasaran=null,$filiku=null,$file1=null,$page=null,$rows=null){
		...
		$pdfdata = $this->rpt_pengukurane1_model->easyGrid($filtahun,$filsasaran,$filiku,$file1,2,$page,$rows);
	...
	//	$this->our_pdf->setAutoPageBreak(true,10);
		...
		if (($file1 != null)&&($file1 != "-1"))
		 ...
		 $this->our_pdf->text($posX,$posY,'Pengukuran Kinerja '.($e1!=""?$e1:"Eselon I "));
		...
		$this->our_pdf->Output("LaporanPengukuranEselon1.pdf","I");
	}
