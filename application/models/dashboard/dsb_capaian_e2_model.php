...
class Dsb_capaian_e2_model extends CI_Model
{	
	/**
	* constructor
	*/
	...
	public function easyGrid($filtahun=null,$filsasaran=null,$purpose=1){
		...
		//if($filsasaran != '' && $filsasaran != '0' && $filsasaran != '-1' && $filsasaran != null) {
			 ...
			 $this->db->where("tbl_pengukuran_eselon2.kode_sasaran_e2",$filsasaran);
		 //}	
			...
			//$this->db->distinct();
			/*select tbl_pengukuran_eselon2.tahun,tbl_pengukuran_eselon2.kode_e1, tbl_eselon1.nama_e1,count(tbl_pengukuran_eselon2.kode_ikk) as jml_iku,
0 as tercapai,0 as tdk_tercapai
from tbl_pengukuran_eselon2 inner join tbl_eselon1
group by tahun,kode_e1, nama_e1*/
			...
			$this->db->select("tbl_ikk.deskripsi,tbl_ikk.satuan,tbl_pk_eselon2.target,tbl_pengukuran_eselon2.persen,tbl_pengukuran_eselon2.realisasi,tbl_pengukuran_eselon2.kode_e2",false);
			
			$this->db->from('tbl_pengukuran_eselon2 inner join tbl_eselon2 on tbl_pengukuran_eselon2.kode_e2 = tbl_eselon2.kode_e2 inner join tbl_ikk on tbl_ikk.kode_ikk=tbl_pengukuran_eselon2.kode_ikk and tbl_pengukuran_eselon2.tahun=tbl_ikk.tahun inner join tbl_pk_eselon2 on tbl_pk_eselon2.kode_ikk=tbl_pengukuran_eselon2.kode_ikk and tbl_pengukuran_eselon2.tahun=tbl_pk_eselon2.tahun and tbl_pengukuran_eselon2.kode_sasaran_e2 = tbl_pk_eselon2.kode_sasaran_e2',false);
...
*/
	...
	public function getPersen($tahun,$kode_e1,$filsasaran,$isTercapai){
		...
		$this->db->where('kode_e2', $kode_e1);
		 if($filsasaran != '' && $filsasaran != '0' && $filsasaran != '-1' && $filsasaran != null) 
		$this->db->where('kode_sasaran_e2', $filsasaran);
		$query = $this->db->get();
		if ($query->num_rows()>0)
