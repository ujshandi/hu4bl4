	...
	*/
	...
	public function easyGrid(){
		...
		if ($count>0){
			...
			$this->db->select("tbl_kinerja_eselon2.tahun, tbl_kinerja_eselon2.triwulan, tbl_kinerja_eselon2.kode_satker, tbl_kinerja_eselon2.kode_sasaran_e2, tbl_kinerja_eselon2.kode_ikk, tbl_pk_eselon2.penetapan, tbl_pk_eselon2.satuan, tbl_kinerja_eselon2.realisasi");
	...
	public function getListEselon2($objectId){
	...
	public function getListsatker($objectId){
		...
		$out = '<select id="kode_satker'.$objectId.'" name="kode_satker" class="easyui-validatebox" required="true">';
	...
	public function getListSasaranE2($objectId){
		...
		/*
		$out = '<select id="kode_sasaran_e2'.$objectId.'" name="kode_sasaran_e2" onchange="getDetail()" class="easyui-validatebox" required="true">';
		...
		*/
		...
		$out .= '<textarea name="txtkode_sasaran_e2'.$objectId.'" name="txtkode_sasaran_e2'.$objectId.'" class="easyui-validatebox textdown" required="true" readonly>-- Pilih --</textarea>';
	...
	public function getDetail($tahun, $kode_satker, $kode_sasaran_e2, $objectId){
		$this->db->flush_cache();
		$this->db->select('tbl_pk_eselon2.tahun, tbl_pk_eselon2.kode_satker, tbl_pk_eselon2.kode_sasaran_e2, tbl_pk_eselon2.kode_ikk, tbl_pk_eselon2.satuan, tbl_pk_eselon2.penetapan, tbl_ikk.deskripsi');
		$this->db->from('tbl_pk_eselon2');
		$this->db->join('tbl_ikk','tbl_pk_eselon2.kode_ikk = tbl_ikk.kode_ikk');
		$this->db->where('tbl_pk_eselon2.tahun', $tahun);
		$this->db->where('tbl_pk_eselon2.kode_satker', $kode_satker);
