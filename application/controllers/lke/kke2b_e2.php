...
class Kke2b_e2 extends CI_Controller {
	var $objectId = 'kke2b_e2';
	function __construct()	
	{
		...
		$this->load->model('/lke/kke2b_e2_model');
	...
	function index(){
		...
		$data['renstra_a_radio'] = $this->lke_konversi_model->getListIndex($this->objectId,array('jenis_lke'=>'kke2b','unit_kerja'=>'e2'),true,"renstra_a");
		$data['rkt_a_radio'] = $this->lke_konversi_model->getListIndex($this->objectId,array('jenis_lke'=>'kke2b','unit_kerja'=>'e2'),true,"rkt_a");
		$data['pk_a_radio'] = $this->lke_konversi_model->getListIndex($this->objectId,array('jenis_lke'=>'kke2b','unit_kerja'=>'e2'),true,"pk_a");
		$data['renstra_b_radio'] = $this->lke_konversi_model->getListIndex($this->objectId,array('jenis_lke'=>'kke2b','unit_kerja'=>'e2'),true,"renstra_b");
		$data['rkt_b_radio'] = $this->lke_konversi_model->getListIndex($this->objectId,array('jenis_lke'=>'kke2b','unit_kerja'=>'e2'),true,"rkt_b");
		$data['pk_b_radio'] = $this->lke_konversi_model->getListIndex($this->objectId,array('jenis_lke'=>'kke2b','unit_kerja'=>'e2'),true,"pk_b");
		
		$data['listIndex_renstra_a'] = $this->lke_konversi_model->getCountIndex(array('jenis_lke'=>'kke2b','unit_kerja'=>'e2'),true);
		$data['listIndex_renstra_b'] = $this->lke_konversi_model->getCountIndex(array('jenis_lke'=>'kke2b','unit_kerja'=>'e2'),true);
		$data['listIndex_rkt_a'] = $this->lke_konversi_model->getCountIndex(array('jenis_lke'=>'kke2b','unit_kerja'=>'e2'),true);
		$data['listIndex_rkt_b'] = $this->lke_konversi_model->getCountIndex(array('jenis_lke'=>'kke2b','unit_kerja'=>'e2'),true);
		$data['listIndex_pk_a'] = $this->lke_konversi_model->getCountIndex(array('jenis_lke'=>'kke2b','unit_kerja'=>'e2'),true);
		$data['listIndex_pk_b'] = $this->lke_konversi_model->getCountIndex(array('jenis_lke'=>'kke2b','unit_kerja'=>'e2'),true);
		
	  	$this->load->view('lke/kke2b_e2_v',$data);
	}
	
	private function get_form_values() {
		$dt['tahun'] = $this->input->post("tahun", TRUE); 
		$dt['kke2b_e2_id'] = $this->input->post("kke2b_e2_id", TRUE); 
		...
		$dt['renstra_a_nilai'] = $this->lke_konversi_model->getKonversi('kke2b',$dt['renstra_a'],'e2');
		$dt['rkt_a'] = $this->input->post("rkt_a", TRUE); 
		$dt['rkt_a_nilai'] = $this->lke_konversi_model->getKonversi('kke2b',$dt['rkt_a'],'e2');
		$dt['pk_a'] = $this->input->post("pk_a", TRUE); 
		$dt['pk_a_nilai'] = $this->lke_konversi_model->getKonversi('kke2b',$dt['pk_a'],'e2');
		$dt['renstra_b'] = $this->input->post("renstra_b", TRUE); 
		$dt['renstra_b_nilai'] = $this->lke_konversi_model->getKonversi('kke2b',$dt['renstra_b'],'e2');
		$dt['rkt_b'] = $this->input->post("rkt_b", TRUE); 
		$dt['rkt_b_nilai'] = $this->lke_konversi_model->getKonversi('kke2b',$dt['rkt_b'],'e2');
		$dt['pk_b'] = $this->input->post("pk_b", TRUE); 
		$dt['pk_b_nilai'] = $this->lke_konversi_model->getKonversi('kke2b',$dt['pk_b'],'e2');
	...
	//	$this->form_validation->set_rules("index_mutu", 'Index Mutu', 'trim|required|xss_clean');
		...
		if ($this->form_validation->run() == FALSE){ // jika tidak valid
			...
			// validasi detail
				...
				if ($data['kke2b_e2_id']==''){	
					$result = $this->kke2b_e2_model->InsertOnDb($data,$data['pesan_error']);
				}
				else {
					$result = $this->kke2b_e2_model->UpdateOnDb($data,$data['kke2b_e2_id']);
				}
	...
	function grid($filtahun=null,$file1=null,$filsasaran=null,$filiku=null){
		...
		echo $this->kke2b_e2_model->easyGrid($filtahun,$file1,$filsasaran,$filiku);
	}
	
	public function excel($filtahun=null,$file1=null,$filsasaran=null,$filiku=null,$page=null,$rows=null){
		echo  $this->kke2b_e2_model->easyGrid($filtahun,$file1,$filsasaran,$filiku,3,$page,$rows);
	}
	...
	public function pdf($filtahun=null,$file1=null,$filsasaran=null,$filiku=null,$page=null,$rows=null){
		...
		$pdfdata = $this->kke2b_e2_model->easyGrid($filtahun,$file1,$filsasaran,$filiku,2,$page,$rows);
	...
	function getSatuan($id){
		echo $this->kke2b_e2_model->getSatuan($id);
	}
