...
class Kke1_3_e2 extends CI_Controller {
	var $objectId = 'kke1_3_e2';
	function __construct()
	{
		...
		$this->load->model('/lke/kke1_3_e2_model');
	...
	function index(){
		...
		$data['catatan_keuangan_radio'] = $this->lke_konversi_model->getListIndex($this->objectId,array('jenis_lke'=>'kke1_3','unit_kerja'=>'e2'),true,"catatan_keuangan");
		$data['masyarakat_radio'] = $this->lke_konversi_model->getListIndex($this->objectId,array('jenis_lke'=>'kke1_3','unit_kerja'=>'e2'),true,"masyarakat");
		$data['instansi_lainnya_radio'] = $this->lke_konversi_model->getListIndex($this->objectId,array('jenis_lke'=>'kke1_3','unit_kerja'=>'e2'),true,"instansi_lainnya");
		$data['transparansi_radio'] = $this->lke_konversi_model->getListIndex($this->objectId,array('jenis_lke'=>'kke1_3','unit_kerja'=>'e2'),true,"transparansi");
		$data['penghargaan_radio'] = $this->lke_konversi_model->getListIndex($this->objectId,array('jenis_lke'=>'kke1_3','unit_kerja'=>'e2'),true,"penghargaan");
		
		$data['listIndex_catatan_keuangan'] = $this->lke_konversi_model->getCountIndex(array('jenis_lke'=>'kke1_3','unit_kerja'=>'e2'),true);
		$data['listIndex_masyarakat'] = $this->lke_konversi_model->getCountIndex(array('jenis_lke'=>'kke1_3','unit_kerja'=>'e2'),true);
		$data['listIndex_instansi_lainnya'] = $this->lke_konversi_model->getCountIndex(array('jenis_lke'=>'kke1_3','unit_kerja'=>'e2'),true);
		$data['listIndex_transparansi'] = $this->lke_konversi_model->getCountIndex(array('jenis_lke'=>'kke1_3','unit_kerja'=>'e2'),true);
		$data['listIndex_penghargaan'] = $this->lke_konversi_model->getCountIndex(array('jenis_lke'=>'kke1_3','unit_kerja'=>'e2'),true);
		
	  	$this->load->view('lke/kke1_3_e2_v',$data);
	}
	
	private function get_form_values() {
		$dt['tahun'] = $this->input->post("tahun", TRUE); 
		$dt['kke13_e2_id'] = $this->input->post("kke13_e2_id", TRUE); 
		...
		$dt['catatan_keuangan_nilai'] = $this->lke_konversi_model->getKonversi('kke1_3',$dt['catatan_keuangan'],'e2');
		$dt['masyarakat'] = $this->input->post("masyarakat", TRUE); 
		$dt['masyarakat_nilai'] = $this->lke_konversi_model->getKonversi('kke1_3',$dt['masyarakat'],'e2');
		$dt['instansi_lainnya'] = $this->input->post("instansi_lainnya", TRUE); 
		$dt['instansi_lainnya_nilai'] = $this->lke_konversi_model->getKonversi('kke1_3',$dt['instansi_lainnya'],'e2');
		$dt['transparansi'] = $this->input->post("transparansi", TRUE); 
		$dt['transparansi_nilai'] = $this->lke_konversi_model->getKonversi('kke1_3',$dt['transparansi'],'e2');
		$dt['penghargaan'] = $this->input->post("penghargaan", TRUE); 
		$dt['penghargaan_nilai'] = $this->lke_konversi_model->getKonversi('kke1_3',$dt['penghargaan'],'e2');
		return $dt;
    }
	...
	function save(){
		...
		$this->form_validation->set_rules("kode_e2", 'Unit Kerja Eselonn I', 'trim|required|xss_clean');
	//	$this->form_validation->set_rules("index_mutu", 'Index Mutu', 'trim|required|xss_clean');
		...
		if ($this->form_validation->run() == FALSE){ // jika tidak valid
			...
			// validasi detail
				...
				if ($data['kke13_e2_id']==''){	
					$result = $this->kke1_3_e2_model->InsertOnDb($data,$data['pesan_error']);
				}
				else {
					$result = $this->kke1_3_e2_model->UpdateOnDb($data,$data['kke13_e2_id']);
				}
	...
	function grid($filtahun=null,$file2=null,$filsasaran=null,$filiku=null){
		...
		echo $this->kke1_3_e2_model->easyGrid($filtahun,$file2,$filsasaran,$filiku);
	}
	
	public function excel($filtahun=null,$file2=null,$filsasaran=null,$filiku=null,$page=null,$rows=null){
		echo  $this->kke1_3_e2_model->easyGrid($filtahun,$file2,$filsasaran,$filiku,3,$page,$rows);
	}
	...
	public function pdf($filtahun=null,$file2=null,$filsasaran=null,$filiku=null,$page=null,$rows=null){
		...
		$pdfdata = $this->kke1_3_e2_model->easyGrid($filtahun,$file2,$filsasaran,$filiku,2,$page,$rows);
	...
	function getSatuan($id){
		echo $this->kke1_3_e2_model->getSatuan($id);
	}
