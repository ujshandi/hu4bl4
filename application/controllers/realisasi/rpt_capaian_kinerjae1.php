...
class Rpt_capaian_kinerjae1 extends CI_Controller {
	...
	function __construct()
	{
		...
		$this->load->model('/realisasi/rpt_capaian_kinerjae1_model');
	...
	function index(){
		$data['title'] = 'Laporan Realisasi Kinerja Eselon I';	
		$data['objectId'] = 'rpt_capaian_kinerjae1';
		//$data['formLookupTarif'] = $this->tarif_model->lookup('#winLookTarif'.$data['objectId'],"#medrek_id".$data['objectId']);
	  	$this->load->view('realisasi/rpt_capaian_kinerjae1_v',$data);
	}
			
	public function grid($filtahun=null,$filsasaran=null,$filiku=null,$file1=null,$filStart=null,$filEnd=null){
		echo $this->rpt_capaian_kinerjae1_model->easyGrid($filtahun,$filsasaran,$filiku,$file1,$filStart,$filEnd);
	}
	
	public function excel($filtahun=null,$filsasaran=null,$filiku=null,$file1=null,$filStart=null,$filEnd=null,$page=null,$rows=null){
		echo  $this->rpt_capaian_kinerjae1_model->easyGrid($filtahun,$filsasaran,$filiku,$file1,$filStart,$filEnd,3,$page,$rows);
	}
	
	public function pdf($filtahun=null,$filsasaran=null,$filiku=null,$file1=null,$filStart=null,$filEnd=null,$page=null,$rows=null){
		$this->load->library('our_pdf');
		$this->our_pdf->FPDF('L', 'mm', 'legal'); 
		$pdfdata = $this->rpt_capaian_kinerjae1_model->easyGrid($filtahun,$filsasaran,$filiku,$file1,$filStart,$filEnd,2,$page,$rows);
	...
	//	$this->our_pdf->setAutoPageBreak(true,10);
		...
		if (($file1 != null)&&($file1 != "-1"))
		 ...
		 $this->our_pdf->text($posX,$posY,'Realisasi Kinerja '.($e1!=""?$e1:"Eselon I "));
		...
		$this->our_pdf->Output("CapaianKinerjaEselon1.pdf","I");
	}
}
?>