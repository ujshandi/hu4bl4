...
class Dsb_capaian_kl extends CI_Controller {
	...
	//if ($this->session->userdata('logged_in') != TRUE) redirect('security/login');					
		...
		$this->load->model('/dashboard/dsb_capaian_kl_model');
	...
	function index()
	{
		...
		$this->load->view('dashboard/dsb_capaian_kl_vw',$data);
	...
	public function grid($filtahun=null,$filsasaran=null){
		...
		echo $this->dsb_capaian_kl_model->easyGrid($filtahun,$filsasaran);
		 $this->dataPie = $this->dsb_capaian_kl_model->dataPie;
	...
	function getDataPie($filtahun=null){
		//  $data = $this->dsb_capaian_kl_model->dataPie;// 
		  
		// $this->dsb_capaian_kl_model->easyGrid($filtahun);
		// $this->dataPie = $this->dsb_capaian_kl_model->dataPie;
		//  $data = array("Tercapai"=>20,"Tidak Tercapai"=>3);
		//	var_dump($this->dataPie);die;
