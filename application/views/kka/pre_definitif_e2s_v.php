	<script  type="text/javascript" >
		$(function(){
			...
			getUrl<?=$objectId;?> = function (tipe){
				...
				if (tipe==1){
					return "<?=base_url()?>kka/pre_definitif_e2/grid/"+filtahun+"/"+file1;
				}
				else if (tipe==2){
					return "<?=base_url()?>kka/pre_definitif_e2/pdf/"+filtahun+"/"+file1;
				}else if (tipe==3){
					return "<?=base_url()?>kka/pre_definitif_e2/excel/"+filtahun+"/"+file1;
				}
			}
