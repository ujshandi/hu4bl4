		...
		<tr>
			...
			<div class="fsearch"?>
				...
				<tr>
					<td>Tahun :</td>
					<td>
					<?=$this->pre_definitif_e1_model->getListFilterTahun($objectId)?>
					</td>
					<td width="10px"></td>
					<td>
...
<table id="dg<?=$objectId;?>" style="height:auto;width:auto" title="Data Pra Monev Definitif" toolbar="#tb<?=$objectId;?>" fitColumns="true" singleSelect="true" rownumbers="true" pagination="true" nowrap="false">
	<thead>
	<tr>
