...
<div id="tb<?=$objectId;?>" style="height:auto">
	...
	<table id="dg<?=$objectId;?>" style="height:auto;width:auto" title="Data Unit Kerja Eselon II" toolbar="#tb<?=$objectId;?>" fitColumns="true" singleSelect="true" rownumbers="true" pagination="true" nowrap="false">
	<thead>
		<tr>
