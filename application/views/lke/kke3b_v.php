	<script  type="text/javascript" >
		$(function(){
			...
			newData<?=$objectId;?> = function (){  
				...
				//addTab("Add PK Kementerian", "lke/kke3b/add");
			}
	...
	<table id="dg<?=$objectId;?>"  style="height:auto;width:auto" title="Laporan KKE3A IK" toolbar="#tb<?=$objectId;?>" fitColumns="false" singleSelect="true" rownumbers="false" pagination="true"  nowrap="false" showFooter="true">
	  <thead>
	  <tr>
