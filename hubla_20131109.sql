...
) ENGINE=MyISAM AUTO_INCREMENT=61 DEFAULT CHARSET=latin1 COMMENT='latin1_swedish_ci';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `tbl_lke_pusat_detail`
--

DROP TABLE IF EXISTS `tbl_lke_pusat_detail`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tbl_lke_pusat_detail` (
  `lkepusat_id` int(11) NOT NULL DEFAULT '0',
  `id_komponen` int(11) NOT NULL DEFAULT '0',
  `persen` float DEFAULT NULL,
  PRIMARY KEY (`lkepusat_id`,`id_komponen`),
  KEY `fk_lke_pusat_detail_komponen` (`id_komponen`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tbl_lke_pusat_detail`
--

LOCK TABLES `tbl_lke_pusat_detail` WRITE;
/*!40000 ALTER TABLE `tbl_lke_pusat_detail` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_lke_pusat_detail` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2013-11-09 20:14:38
